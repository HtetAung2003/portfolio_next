...
export function SlideButton({
    ...
    return (
        <Button
            className="relative overflow-visible  from-primary to-secondary text-black px-20 py-8 rounded-full transition-all duration-500 ease-in-out  "
